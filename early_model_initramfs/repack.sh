...
COMPILER=~/android/kernel-workshop/toolchains/arm-eabi-4.4.3/bin/arm-eabi
COMPILER_LIB=~/android/kernel-workshop/toolchains/arm-eabi-4.4.3/lib/gcc/arm-eabi/4.4.3
##############################################################################
#set -x
