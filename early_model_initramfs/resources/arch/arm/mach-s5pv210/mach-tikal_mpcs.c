...
static struct sec_jack_buttons_zone sec_jack_buttons_zones[] = {
	...
	{
		/* 160 <= adc <= 360, stable zone */
		.code		= KEY_VOLUMEUP,
		.adc_low	= 160,
		.adc_high	= 360,
	},
	{
                /* 410 <= adc <= 810, stable zone */
		.code		= KEY_VOLUMEDOWN,
                .adc_low	= 410,
                .adc_high	= 810,
	},
